...
public class TestBanking {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Customer [Jane Simms] has a checking balance of  200.0 and a savings balance of 500.0");
        ...
        customer = bank.getCustomer(1);
        account = customer.getChecking();
        System.out.println("Customer [Owen Bryant] has a checking balance of 200.0");
